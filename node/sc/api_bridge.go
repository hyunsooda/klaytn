...
// SubBridgeAdminAPI exports admin APIs.
type SubBridgeAdminAPI struct {
	subBridge *SubBridge
}

// AddPeer requests connecting to a remote node, and also maintaining the new
// connection at all times, even reconnecting if it is lost.
func (sb *SubBridgeAdminAPI) AddPeer(url string) (bool, error) {
...
func (sb *SubBridgeAdminAPI) RemovePeer(url string) (bool, error) {
	// Make sure the server is running, fail otherwise
	server := sb.subBridge.bridgeServer
	if server == nil {
		return false, node.ErrNodeStopped
...
func (sb *SubBridgeAdminAPI) RegisterOperator(bridgeAddr, operatorAddr common.Address) (common.Hash, error) {
	return sb.subBridge.bridgeManager.RegisterOperator(bridgeAddr, operatorAddr)
}

func (sb *SubBridgeAdminAPI) SetValueTransferOperatorThreshold(bridgeAddr common.Address, threshold uint8) (common.Hash, error) {
	return sb.subBridge.bridgeManager.SetValueTransferOperatorThreshold(bridgeAddr, threshold)
}

func (sb *SubBridgeAdminAPI) DeployBridge() ([]common.Address, error) {
...
func (sb *SubBridgeAdminAPI) SubscribeBridge(cBridgeAddr, pBridgeAddr common.Address) error {
...
func (sb *SubBridgeAdminAPI) UnsubscribeBridge(cBridgeAddr, pBridgeAddr common.Address) error {
	if !sb.subBridge.bridgeManager.IsValidBridgePair(cBridgeAddr, pBridgeAddr) {
		return ErrInvalidBridgePair
	}
...
func (sb *SubBridgeAdminAPI) KASAnchor(blkNum uint64) error {
...
func (sb *SubBridgeAdminAPI) Anchoring(flag bool) bool {
	return sb.subBridge.SetAnchoringTx(flag)
}

func (sb *SubBridgeAdminAPI) RegisterBridge(cBridgeAddr common.Address, pBridgeAddr common.Address) error {
...
func (sb *SubBridgeAdminAPI) DeregisterBridge(cBridgeAddr common.Address, pBridgeAddr common.Address) error {
	if !sb.subBridge.bridgeManager.IsValidBridgePair(cBridgeAddr, pBridgeAddr) {
		return ErrInvalidBridgePair
	}
...
func (sb *SubBridgeAdminAPI) RegisterToken(cBridgeAddr, pBridgeAddr, cTokenAddr, pTokenAddr common.Address) error {
	if !sb.subBridge.bridgeManager.IsValidBridgePair(cBridgeAddr, pBridgeAddr) {
		return ErrInvalidBridgePair
	}
...
func (sb *SubBridgeAdminAPI) DeregisterToken(cBridgeAddr, pBridgeAddr, cTokenAddr, pTokenAddr common.Address) error {
	cBi, cExist := sb.subBridge.bridgeManager.GetBridgeInfo(cBridgeAddr)
	pBi, pExist := sb.subBridge.bridgeManager.GetBridgeInfo(pBridgeAddr)
...
func (sb *SubBridgeAdminAPI) SetKLAYFee(bridgeAddr common.Address, fee *big.Int) (common.Hash, error) {
	return sb.subBridge.bridgeManager.SetKLAYFee(bridgeAddr, fee)
}

func (sb *SubBridgeAdminAPI) SetERC20Fee(bridgeAddr, tokenAddr common.Address, fee *big.Int) (common.Hash, error) {
	return sb.subBridge.bridgeManager.SetERC20Fee(bridgeAddr, tokenAddr, fee)
}

func (sb *SubBridgeAdminAPI) SetFeeReceiver(bridgeAddr, receiver common.Address) (common.Hash, error) {
...
func (sb *SubBridgeAdminAPI) UnlockChildOperator(passphrase string, duration *uint64) error {
...
func (sb *SubBridgeAdminAPI) SetParentOperatorFeePayer(feePayer common.Address) error {
...
func (sb *SubBridgeAdminAPI) SetChildOperatorFeePayer(feePayer common.Address) error {
